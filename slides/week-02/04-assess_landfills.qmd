...
## Let's Get Started
- Find your pair
- Download [Homework 02 folder](case_studies/week-02-Bullard) and open it in Posit Cloud.
...
- One helpful way to troubleshoot, can be typing "?" followed by the function into your environment (i.e., `?scale_fill_manual()`)
